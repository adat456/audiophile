...
const Header: React.FC = ({setCartModal}) => {
    ...
    return(
        <header>
            <div>
                {tablet ? 
                <>
                    <svg className="hamburger" onClick={() => setShowNav(true)} viewBox="0 0 16 15" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF" fillRule="evenodd"><path d="M0 0h16v3H0zM0 6h16v3H0zM0 12h16v3H0z"/></g></svg>
                    {showNav ?
                        <>
                            <nav>
                                <Categories />
